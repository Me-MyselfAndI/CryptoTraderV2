...
def request_get(url, dataType='regular', payload=None, jsonify_data=True, mute_unneeded_prints=True):
    ...
    if (dataType == 'results'):
        ...
        if nextData['next'] and not mute_unneeded_prints:
